            ...
            <Card>
              ...
              <CardFooter className="flex-col gap-4">
                <Button onClick={() => finalizeOrder(pendingOrderData!)} disabled={isLoading} className="w-full">
                  {isLoading ? <><div className="w-8 h-8 mr-2"><AnimatedPlateSpinner /></div>Verifying...</> : <><CheckCircle className="mr-2 h-5 w-5"/>I Have Paid</>}
                </Button>
