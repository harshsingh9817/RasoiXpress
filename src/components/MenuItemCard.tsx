...
import { PlusCircle, Leaf, ShoppingBag, Info } from 'lucide-react';
...
const MenuItemCard: FC<MenuItemCardProps> = ({ menuItem }) => {
  ...
  const handleOpenDetails = (e: React.MouseEvent | React.KeyboardEvent) => {
    e.stopPropagation();
    e.preventDefault();
  ...
  return (
    <>
      <Card className="h-full overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl hover:border-primary group flex flex-col">
